...
{
    IEnumerable<BabyDevForecast> GetBabyDev(int ageRangeStart, int ageRangeEnd);
}
public class BabyDevService: IBabyDevService
{
    ...
    public IEnumerable<BabyDevForecast> GetBabyDev(int ageRangeStart, int ageRangeEnd)
    {
